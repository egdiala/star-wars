...
export const Navbar = () => {
    return <header className="absolute top-0 left-0 right-0 z-10 shadow-md bg-white">
        <div className="flex flex-grow items-center py-5 px-10">
            <div className="flex flex-wrap gap-9 w-fit items-center justify-end ml-auto">
